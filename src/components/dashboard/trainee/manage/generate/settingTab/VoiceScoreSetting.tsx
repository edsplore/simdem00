...
export default function VoiceAndScoreSettings({ prompt }: VoiceScoreSettingProps) {
    ...
    const { control, handleSubmit, watch } = useForm<VoiceScoreFormData>({
        defaultValues: {
            language: "English",
            accent: "American",
            gender: "Male",
    ...
    const onSubmit = (data: VoiceScoreFormData) => {
